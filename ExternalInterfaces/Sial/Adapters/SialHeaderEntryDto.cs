...
*                                                                                                            *
*  Summary  : Output DTO used to return SIAL payroll entry data                                              *
*                                                                                                            *
...
namespace Empiria.BanobrasIntegration.Sial.Adapters {
  ...
  /// <summary>Output DTO used to return SIAL payroll entry data</summary>
  public class SialHeaderEntryDto {
