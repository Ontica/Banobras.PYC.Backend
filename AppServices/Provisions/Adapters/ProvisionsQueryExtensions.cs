...
*  Assembly : Banobras.PYC.AppServices.dll               Pattern   : Query Type Extensions                   *
*  Type     : ProvisionsQueryExtensions                  License   : Please read LICENSE.txt file            *
*                                                                                                            *
...
namespace Empiria.Provisions.Adapters {
  ...
  static internal class ProvisionsQueryExtensions {

    #region Extension Methods

    static internal void EnsureIsValid(this ProvisionsQuery query) {
      Assertion.Require(query.OrderTypeUID, nameof(query.OrderTypeUID));
    }

    static internal string MapToFilterString(this ProvisionsQuery query) {
    ...
    static internal string MapToSortString(this ProvisionsQuery query) {
  ...
  }  // class ProvisionsQueryExtensions
