/* Banobras - PYC ********************************************************************************************
*                                                                                                            *
*  Module   : Banobras Procurement Services                 Component : Web Api                              *
*  Assembly : Banobras.PYC.WebApi.dll                       Pattern   : Web Api Controller                   *
*  Type     : OrderUseCaseDispatcher                        License   : Please read LICENSE.txt file         *
*                                                                                                            *
...
namespace Empiria.Banobras.Procurement.WebApi {
  ...
  static internal class OrderUseCaseDispatcher {
    ...
    static internal FixedList<OrderDescriptor> AvailableOrders(OrdersQuery query) {
      ...
      var forUseInOrderTypeUID = OrderType.Parse(query.ForUseInOrderTypeUID);
