...
*  Type     : CashFlowSearchServicesController             License   : Please read LICENSE.txt file          *
*                                                                                                            *
...
using Empiria.Banobras.Tooling.AppServices;
...
namespace Empiria.Banobras.Reporting.WebApi {
  ...
  public class CashFlowSearchServicesController : WebApiController {
    ...
    public async Task<SingleObjectModel> SearchExternalCreditEntries([FromBody] RecordsSearchQuery query) {
      ...
      using (var services = ToolingServices.ServiceInteractor()) {
  ...
  }  // class CashFlowSearchServicesController
