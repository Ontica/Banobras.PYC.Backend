...
*  Type     : PaymentOrderAsVoucherBuilder                  License   : Please read LICENSE.txt file         *
*                                                                                                            *
*  Summary  : Builds a PDF file with a payment order with its associated budget concepts and bills.          *
*                                                                                                            *
...
namespace Empiria.Payments.Reporting {
  ...
  /// <summary>Builds a PDF file with a payment order with its associated budget concepts and bills.</summary>
